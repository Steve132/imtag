...
public:
	...
	void to_rgba_adjacencies_image(uint8_t* image, const std::vector<std::vector<bool>>& hole_adjacencies_matrix, const std::array<uint8_t,4>& background_color = {0,0,0,0}) const;
